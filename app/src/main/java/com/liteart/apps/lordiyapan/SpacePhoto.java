...
/**
 * Created by magudesh on 12/2/17.
 */
...
public class SpacePhoto implements Parcelable {
    ...
    public static  SpacePhoto[] getSpacePhotos(ArrayList<String> urlList, ArrayList<String> titleList) {
        SpacePhoto[] temp=new SpacePhoto[urlList.size()];
        for(int i=0;i<urlList.size();i++)
        {
            temp[i]=new SpacePhoto(urlList.get(i), titleList.get(i));
        }
